...
const SAFEMARS_ADDRESS = '0x0607396970188b2e524c1cde4af1f9a191dee150'
export const SAFEMARS: { [chainId in ChainId]: Token } = {
    [ChainId.MAINNET]: new Token(ChainId.MAINNET, SAFEMARS_ADDRESS, 9, 'SRA', 'Sierra'),
    [ChainId.BSCTESTNET]: new Token(ChainId.BSCTESTNET, '0x0000000000000000000000000000000000000000', 9, 'SRA', 'Sierra')
}
